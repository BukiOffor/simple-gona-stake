...
async fn main() -> Result<(), Error> {
    ...
    use gona_stake::types::InitParam;  // Example
    ...
    let init_method_name: &str = "init_gona_stake"; // Example
    ...
    //     receive_name: OwnedReceiveName::new_unchecked("gona_stake.receive".to_string()),
...
// cargo run -- --node http://node.testnet.concordium.com:20000 --account ~/38TN6fTCjgHYp7vXDagLJsb6s3UHzDANaGS2wXwgQLBUJrEian.export --module /Users/mac/staking-dApp/contract/dist/stake.wasm.v1
